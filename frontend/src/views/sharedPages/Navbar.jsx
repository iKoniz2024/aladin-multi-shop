            ...
            <div className="bg-[#0B3C73] dark:bg-[#081a30]">
                <div className="mx-auto flex h-16 sm:h-20 max-w-7xl items-center justify-between px-4 gap-4">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        >
                            <Package className="size-4 shrink-0 text-[#FFA800]" />
                        ...
                        >
                            {mounted && theme === "dark" ? <Sun className="size-4 text-[#FFA800]" /> : <Moon className="size-4 text-[#FFA800]" />}
                        </button>
                        ...
                        {(!user || (user.role !== "admin" && user.role !== "vendor")) && (
                            ...
                            >
                                ...
                                {mounted && cartCount > 0 && (
                                    <span className="absolute -right-1.5 -top-1.5 flex size-5 items-center justify-center rounded-full bg-[#FFA800] text-[#0B3C73] text-[10px] font-black shadow-md">
                                        {cartCount}
                                    </span>
                                )}
                            </Link>
                            ...
                            user ? (
                                <div ref={profileRef} className="relative group/profile">
                                    <button
                                        ...
                                        className="flex size-9 items-center justify-center rounded-full bg-[#FFA800] text-[#0B3C73] text-sm font-black shadow-md ring-2 ring-white/30 transition-all duration-200 hover:scale-105 cursor-pointer"
                                        title="Account Menu"
                                    >
                ...
                <div className="relative mx-auto max-w-7xl px-4">
                    <div className="flex h-12 sm:h-13 items-center justify-between">
                        <div className="flex items-center gap-1.5">
                            <Link href="/" className={`flex items-center gap-2 rounded-xl px-4 py-2 text-xs sm:text-sm font-bold transition-all ${pathname === "/" ? "bg-white/20 text-[#FFA800] border border-white/30 shadow-2xs" : "text-white hover:bg-white/10 hover:text-[#FFA800]"}`}>
                            ...
                            <div className="group/cat">
                                <button className="flex items-center gap-2 rounded-xl px-4 py-2 text-xs sm:text-sm font-bold text-white hover:bg-white/10 hover:text-[#FFA800] transition-all cursor-pointer">
                            ...
                            <Link href="/products" className={`flex items-center gap-2 rounded-xl px-4 py-2 text-xs sm:text-sm font-bold transition-all ${pathname === "/products" ? "bg-white/20 text-[#FFA800] border border-white/30 shadow-2xs" : "text-white hover:bg-white/10 hover:text-[#FFA800]"}`}>
                            ...
                            <Link
                                href="/best-selling"
                                className={`flex items-center gap-2 rounded-xl px-4 py-2 text-xs sm:text-sm font-bold transition-all ${pathname === "/best-selling" ? "bg-white/20 text-[#FFA800] border border-white/30 shadow-2xs" : "text-white hover:bg-white/10 hover:text-[#FFA800]"}`}
                            >
                            ...
                            <Link
                                href="/flash-sale"
                                className={`flex items-center gap-2 rounded-xl px-4 py-2 text-xs sm:text-sm font-bold transition-all ${pathname === "/flash-sale" ? "bg-white/20 text-[#FFA800] border border-white/30 shadow-2xs" : "text-white hover:bg-white/10 hover:text-[#FFA800]"}`}
                            >
                                <Zap className="size-4 text-[#FFA800] fill-[#FFA800]/20" />
