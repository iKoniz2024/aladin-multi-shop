      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-3.5 lg:grid-cols-12 lg:items-stretch">
          ...
          <div className="hidden lg:col-span-4 xl:col-span-3 lg:flex lg:flex-col justify-between gap-3.5 h-full overflow-hidden">
            ...
            <div className="rounded-2xl border border-[#FFE8D6] bg-[#FFF8F0] p-3.5 sm:p-4 shadow-xs flex flex-col justify-between gap-3 shrink-0 dark:bg-slate-900 dark:border-slate-800">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-[#E0F2FE] border border-sky-200/80 px-2.5 py-1 text-xs font-bold text-[#0B3C73] dark:bg-sky-950/40 dark:border-sky-900/50 dark:text-sky-300">
                  <Sparkles className="size-3.5 text-[#0B3C73]" /> Featured Store
                </span>
              ...
              {featuredVendor ? (
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    {featuredVendor.vendorInfo?.shopLogo || featuredVendor.avatar ? (
                      ...
                      <div className="size-12 rounded-2xl bg-white dark:bg-slate-800 flex items-center justify-center text-lg font-black text-[#0B3C73] dark:text-sky-300 shrink-0 border border-slate-200 shadow-2xs">
                  ...
                  <Link
                    ...
                    className="block w-full rounded-full bg-[#0B3C73] hover:bg-[#072a52] py-1.5 text-center text-xs sm:text-sm font-bold text-white transition-all shadow-xs cursor-pointer"
                  >
                    Visit Store
                  </Link>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="size-12 rounded-2xl bg-white dark:bg-slate-800 flex items-center justify-center text-lg font-black text-[#0B3C73] shrink-0 border border-slate-200 shadow-2xs">
                      S
                    </div>
                    <div className="truncate flex-1 min-w-0">
                      <h4 className="text-sm font-bold text-slate-900 dark:text-white truncate">Aladiinn Verified Store</h4>
                      <p className="text-xs text-slate-500 dark:text-slate-400 truncate mt-0.5 font-medium">vendor@aladiinn.com</p>
                    </div>
                  </div>
                  <Link
                    href="/products"
            ...
            <div className="rounded-2xl border border-[#FFE8D6] bg-[#FFF8F0] p-3.5 sm:p-4 shadow-xs flex flex-col justify-start gap-2.5 shrink-0 dark:bg-slate-900 dark:border-slate-800">
              ...
              <Link
                href="/products"
                className="block w-full rounded-full bg-[#FF0055] hover:bg-[#e0004b] py-1.5 text-center text-xs sm:text-sm font-extrabold text-white transition-all shadow-md shrink-0 cursor-pointer"
              >
                Order Now
              </Link>
            </div>
