...
export async function generateMetadata() {
  ...
  const defaultMetadata = {
    title: {
      default: "Aladiinn Shop | Multi-Category E-Commerce Store",
      template: "%s | Aladiinn Shop",
    },
    ...
    metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || "https://aladiinnshop.com"),
    alternates: {
      canonical: "/",
    },
  };
